...
float prueba=0;
int16_t copiacord[6] = {0, 0, 0, 0, 0, 0};
...
void publishPositions(void)
{
  ...
  */
  ...
  poscion.data = copiacord; // Asignar memoria para el array de datos
