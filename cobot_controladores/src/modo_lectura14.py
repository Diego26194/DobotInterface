...
class ModoLectura:
    ...
    def AngulosArticulares_a_pose(self, cord_ang_grados):
        ...
        rospy.logwarn("coordenadas en radianes")
        rospy.logwarn(cord_ang_rad)
        algo=self.move_group.set_joint_value_target(cord_ang_rad)
        
        rospy.logwarn("algo intermedio")
        rospy.logwarn(algo)
        ...
        rospy.logwarn("resultado 1 en pose")
        rospy.logwarn(pose)
        return pose
    ...
    def AngulosArticulares_a_cartesianasEuler(self, cord_ang_grados):
        ...
        return: [x,y,z,roll,pitch,yaw] en grados
        """
        rospy.logwarn("entrada principal en grados")
        rospy.logwarn(cord_ang_grados)
        pose = self.AngulosArticulares_a_pose(cord_ang_grados)
        rospy.logwarn("entrada principal en pose")
        rospy.logwarn(pose)
