...
from moveit_msgs.msg import RobotTrajectory, RobotState, MotionSequenceRequest, MotionSequenceItem, MotionPlanRequest,MoveGroupSequenceAction, Constraints, MoveGroupSequenceGoal, GenericTrajectory, Constraints
...
class ControladorRobot:
    ...
    #////////fin de cambio////////
                ...
                for i, joint_name in enumerate(traj.joint_names):
                    rospy.loginfo(i)
                    joint_constraint = JointState()
                    joint_constraint.name = joint_name
                    rospy.loginfo(joint_name)
